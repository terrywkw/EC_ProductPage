/**
 * ImageToTextService - A service for generating product descriptions from images using Google Gemini Pro 2.0
 * This service leverages Google's multimodal capabilities to analyze product images
 * and generate high-quality product descriptions.
 */
class ImageToTextService {
    constructor(apiKey) {
        this.apiKey = apiKey;
        this.apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-pro-vision:generateContent?key=${apiKey}`;
    }
    ...
    async generateDescriptionFromImage(base64Image, productName = '', options = {}) {
        ...
        try {
            // Using the enhanced Gemini 2.0 API for better image analysis
    ...
    async generateWithImageEditing(base64Image, instruction) {
        ...
        // Using Gemini 2.0 for image-to-image generative tasks
...
// Export the service
window.ImageToTextService = ImageToTextService;
